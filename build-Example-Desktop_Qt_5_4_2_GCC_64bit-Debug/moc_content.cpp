...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Content_t, stringdata) + ofs \
...
const QMetaObject Content::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_Content.data,
      qt_meta_data_Content,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Content::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Content.stringdata))
