...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_BaseInfo_t, stringdata) + ofs \
...
const QMetaObject BaseInfo::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_BaseInfo.data,
      qt_meta_data_BaseInfo,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *BaseInfo::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_BaseInfo.stringdata))
