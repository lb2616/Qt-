...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Detail_t, stringdata) + ofs \
...
const QMetaObject Detail::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Detail.data,
      qt_meta_data_Detail,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Detail::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Detail.stringdata))
